...
/**
 * Complexity: Easy
 * LeetCode: <a href="https://leetcode.com/problems/merge-sorted-array/description/">...</a>
 * Time complexity: O(m + n) - one pass over each array.
 * Memory complexity: O(1) -  no additional structures (in-place).
 */
